...
const validateDictionary = (dict: any): dict is Dictionary => {
  ...
  if (
    ...
    !dict.consulting.subtitle ||
    !dict.consulting.description ||
    !dict.consulting.learnMore
  ) {
  ...
  if (
    ...
    !dict.education.discoverMore ||
    !Array.isArray(dict.education.items)
  ) {
  ...
  if (
    !dict.fieldsOfWork.title ||
    !dict.fieldsOfWork.consulting?.title ||
    !dict.fieldsOfWork.consulting?.description ||
    !dict.fieldsOfWork.communityBuilding?.title ||
    !dict.fieldsOfWork.communityBuilding?.description ||
    !dict.fieldsOfWork.eventsContent?.title ||
    !dict.fieldsOfWork.eventsContent?.description
  ) {
  ...
  if (
    !dict.ourStory.title ||
    !dict.ourStory.subtitle ||
    !Array.isArray(dict.ourStory.points) ||
    !dict.ourStory.getInTouch
  ) {
  ...
  if (
    !dict.bookShowcase.title ||
    !dict.bookShowcase.description ||
    !dict.bookShowcase.orderNow
  ) {
